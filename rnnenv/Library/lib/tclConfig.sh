...
# installed.
TCL_PREFIX='D:/DA/Data Science and Artificial Intelligence/5- Machine Learning/56-End to end deep learning project with RNN/Project/rnnenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/DA/Data Science and Artificial Intelligence/5- Machine Learning/56-End to end deep learning project with RNN/Project/rnnenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/DA/Data Science and Artificial Intelligence/5- Machine Learning/56-End to end deep learning project with RNN/Project/rnnenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/DA/Data Science and Artificial Intelligence/5- Machine Learning/56-End to end deep learning project with RNN/Project/rnnenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/DA/Data Science and Artificial Intelligence/5- Machine Learning/56-End to end deep learning project with RNN/Project/rnnenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/DA/Data Science and Artificial Intelligence/5- Machine Learning/56-End to end deep learning project with RNN/Project/rnnenv\Library\lib\tclstub86.lib'
